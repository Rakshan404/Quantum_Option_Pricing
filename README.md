<center><h1>Quantum Option Pricing</h1></center>

<p align="center">
  <img width="302" height="456" alt="Quantum Circuit"
       src="https://github.com/user-attachments/assets/218ffeff-3476-4155-bc8a-6b4a8ee964c8" />
</p>

<p align="center">Quantum Circuit ☝️</p>
...
## 📘 Overview  
*(Comments are provided in the code for line-by-line explanation)*
...
The continuous lognormal distribution is divided into 32 bins.  
For each bin:

- the midpoint price  
- and its probability mass  

are computed. These probabilities form the basis of the amplitude-encoded quantum state.

---

### 2. **Amplitude Encoding**  
The square roots of the bin probabilities are loaded into a 5-qubit register using the `Initialize` instruction.  
This produces a quantum state where all price outcomes are represented in superposition according to their true probabilities.
...
The probability of the ancilla measuring as `|1⟩` is proportional to the normalized expected payoff.  
This value is then rescaled and discounted to obtain the **quantum price estimate**.

---

### 5. **Classical Benchmark**  
Using the same discretized distribution, a classical expected payoff is calculated.  
This serves as the **ground truth** for evaluating the quantum estimate.
